                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 text-end">
                                        <a href="{{ route('admin.blogs.create') }}" class="btn btn-success btn-rounded">
                                        ...
                                        <tbody>
                                            @forelse ($blogs as $blog)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($blog->image)
                                                            <img src="{{ asset('blogs/' . $blog->image) }}" height="50"
                                                                alt="Blog Image">
                                                        @else
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            statusToggles.forEach(toggle => {
                toggle.addEventListener('change', function() {
                    ...
                    fetch(`/admin/blogs/toggle-status/${blogId}`, {
                            method: 'POST',
                            headers: {
                        ...
                        .then(data => {
                            if (!data.success) {
                                ...
                                this.closest('td').querySelector('.form-check-label')
                                    .innerText = newStatus.charAt(0).toUpperCase() + newStatus
                                    .slice(1);
                            }
                        })
                        .catch(() => {
