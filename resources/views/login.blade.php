                ...
                <div class="profile-form-container">
                    ...
                    <form action="#">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password" name="password" placeholder="Wthh@12#$$" value=""
                                maxlength="8" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[\W_])[A-Za-z\d\W_]{8}$"
                                title="Password must contain uppercase, lowercase, number, and special character, and be at least 8 characters long."
                                required>
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            ...
                            <a href="forget.php" class="forgot-pass" style="color: black;">Forgot Password?</a>
                        </div>
