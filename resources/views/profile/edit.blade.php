...
<main class="main">
    ...
    <div class="container py-5" style="padding-left: 10%">
        <div class="row align-items-center">
            ...
            <div class="container max-w-xl mx-auto p-4">
                <h2 class="text-xl font-bold mt-2 mb-2">My Profile</h2>
                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <button type="submit" class="bg-blue-600 text-black px-4 py-2 rounded">Update Profile</button>
                </form>
            </div>
