                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="{{ route('blog')}}">There are many variations of passages orem available.</a>
                                </h4>
                                <p>
                                    It is a long established fact that a reader will majority have suffered distracted
                                    readable.
                                </p>
                                <a class="theme-btn" href="{{ route('blog')}}">Read More<i
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInDown" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="{{ route('blog')}}">Generator internet repeat tend word chunk necessary.</a>
                                </h4>
                                <p>
                                    It is a long established fact that a reader will majority have suffered distracted
                                    readable.
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="{{ route('blog')}}">Survived only five centuries but also the leap into.</a>
                                </h4>
                                <p>
                                    It is a long established fact that a reader will majority have suffered distracted
                                    readable.
