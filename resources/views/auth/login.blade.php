...
@section('content')
                ...
                <div class="col-lg-6">
                    <div class="fade-gallery-wrapper">
                        <div class="fade-gallery-slider">
                            <img src="{{ asset('assets/img/hero/login_logo.png') }}" class="fade-gallery-img active"
                                alt="gallery">
                            <img src="{{ asset('assets/img/hero/login_logo2.png') }}" class="fade-gallery-img"
                                alt="gallery">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="profile-form-container">
                        <div class="login-header">
                           ...
                           <h2>INDIA’S #1 SECURE DOCUMENTATION PLATFORM <br> FOR LANDLORDS</h2>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group" style="position: relative;">
                                ...
                                <i class="fa fa-eye-slash toggle-password" onclick="togglePassword(this)"
                                    style="position: absolute; right: 10px; top: 55px; cursor: pointer;"></i>
                                @error('password')
                                    <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-end align-items-center mb-3">
                                <a href="{{ route('register') }}" class="text-dark small">
    ...
    <script>
        function togglePassword(icon) {
            ...
            // Toggle eye icon class (optional if using font-awesome)
